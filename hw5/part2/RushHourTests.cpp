...
void testMoveVehicle() { //Cheers Akiva.
    ...
    //static_assert(1 == MoveVehicle<gameBoard, 2, 3, LEFT, 2>::boundry_index, "Should be equal, boundry index");
    //Printer<x_2_left_1>::print(std::cout);
    //Printer<x_2_left_2>::print(std::cout);
    ...
    typedef typename MoveVehicle<x_2_left_1, 5, 2, UP, 1>::board b_1_up;
    ...
    Printer<b_1_up>::print(std::cout);

	typedef typename MoveVehicle<b_1_up, 4, 2, UP, 1>::board b_2_up;
	typedef typename MoveVehicle<b_2_up, 0, 4, DOWN, 1>::board b_3_up;
	typedef typename MoveVehicle<b_3_up, 4, 4, LEFT, 2>::board b_4_up;
	typedef typename MoveVehicle<b_4_up, 5, 5, LEFT, 1>::board b_5_up;
	typedef typename MoveVehicle<b_5_up, 5, 4, LEFT, 3>::board b_6_up;
	typedef typename MoveVehicle<b_6_up, 3, 4, UP, 1>::board b_7_up;
	typedef typename MoveVehicle<b_7_up, 2, 4, DOWN, 3>::board b_8_up;
	typedef typename MoveVehicle<b_8_up, 1, 3, RIGHT, 1>::board b_9_up;
	typedef typename MoveVehicle<b_9_up, 1, 3, RIGHT, 1>::board b_10_up;
	//typedef typename MoveVehicle<b_10_up, 4, 2, RIGHT, 2>::board b_11_up;
	Printer<gameBoard>::print(std::cout);
	Printer<x_2_left_1>::print(std::cout);
	Printer<b_1_up>::print(std::cout);
	Printer<b_2_up>::print(std::cout);
	Printer<b_3_up>::print(std::cout);
	Printer<b_4_up>::print(std::cout);
	Printer<b_5_up>::print(std::cout);
	Printer<b_6_up>::print(std::cout);
	Printer<b_7_up>::print(std::cout);
	Printer<b_8_up>::print(std::cout);
	Printer<b_9_up>::print(std::cout);
	Printer<b_10_up>::print(std::cout);
	//Printer<b_11_up>::print(std::cout);
...
void TestCheckSoloution() {
    ...
    > moves;
    static_assert(CheckSolution<gameBoard, moves>::result, "Fail"); // Game should be solved #HERE
    ...
    > movesWrong;
    static_assert(CheckSolution<gameBoard, movesWrong>::result == false, "Fail"); // Game should be solved #HERE
}
